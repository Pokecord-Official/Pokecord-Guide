...
Poke Radar is a special key item that allows re-rolling one selected pokemon from the [spawn](./commands/spawn.md) list. Can be used once every 10 spawns. Also works with `Encounter Tickets`.
